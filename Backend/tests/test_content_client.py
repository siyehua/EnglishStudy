...
class ContentClientTest(unittest.TestCase):
    ...
    def test_lesson_to_content_maps_fields(self) -> None:
        ...
        self.assertEqual(item.audioUrl, "https://cdn.jsdelivr.net/gh/linyuanzky/englishpod365@main/0001-0010/0001/englishpod_B0001pr.mp3")
        self.assertEqual(item.dialogueAudioUrl, "https://cdn.jsdelivr.net/gh/linyuanzky/englishpod365@main/0001-0010/0001/englishpod_B0001rv.mp3")
