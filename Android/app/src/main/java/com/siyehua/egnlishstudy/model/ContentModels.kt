...
sealed class Content(
    ...
    open val audioStart: Double = 0.0,
    open val audioEnd: Double = 0.0
)
...
data class Dialogue(
    ...
    override val audioStart: Double = 0.0,
    override val audioEnd: Double = 0.0
) : Content(id = contentId, title = dialogueTitle, type = ContentType.DIALOGUE, level = contentLevel, sourceName = source, audioUrl = audioUrl, audioStart = audioStart, audioEnd = audioEnd)
